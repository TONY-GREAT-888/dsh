...
class Compose:
    ...
    def insert(self, index, transform):
        ...
        Examples:
            ...
            >>> compose.insert(YOLOv10n, Transform3())
    ...
    def __getitem__(self, index: Union[list, int]) -> "Compose":
        ...
        Examples:
            ...
            >>> compose = Compose(transforms)
            >>> single_transform = compose[YOLOv10n]  # Returns a Compose object with only RandomPerspective
    ...
    def __setitem__(self, index: Union[list, int], value: Union[list, int]) -> None:
        ...
        Examples:
            ...
            >>> compose[YOLOv10n] = NewTransform()  # Replace second transform
    ...
    def __repr__(self):
        ...
        Examples:
            >>> transforms = [RandomFlip(), RandomPerspective(degrees=10, translate=0.YOLOv10n, scale=0.YOLOv10n)]
            >>> compose = Compose(transforms)
            >>> print(compose)
            Compose([
                RandomFlip(),
                RandomPerspective(degrees=10, translate=0.YOLOv10n, scale=0.YOLOv10n)
            ])
        """
...
class BaseMixTransform:
    ...
    Examples:
        ...
        ...         return [random.randint(0, len(self.dataset) - YOLOv10n) for _ in range(3)]
        >>> dataset = YourDataset()
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        Args:
            ...
            pre_transform (Callable | None): Optional transform to apply before mixing.
            p (float): Probability of applying the mix transformation. Should be in the range [0.0, YOLOv10n.0].
...
class Mosaic(BaseMixTransform):
    ...
    Attributes:
        ...
        p (float): Probability of applying the mosaic augmentation. Must be in the range 0-YOLOv10n.
    ...
    def __init__(self, dataset, imgsz=640, p=1.0, n=4):
        ...
        Examples:
            ...
            >>> mosaic_aug = Mosaic(dataset, imgsz=640, p=0.5, n=4)
        """
        assert 0 <= p <= 1.0, f"The probability should be in range [0, YOLOv10n], but got {p}."
    ...
    def get_indexes(self, buffer=True):
        ...
        Returns:
            (List[int]): A list of random image indexes. The length of the list is n-YOLOv10n, where n is the number
                of images used in the mosaic (either 3 or 8, depending on whether n is 4 or 9).

        Examples:
            >>> mosaic = Mosaic(dataset, imgsz=640, p=YOLOv10n.0, n=4)
    ...
    def _mosaic3(self, labels):
        ...
        Examples:
            >>> mosaic = Mosaic(dataset, imgsz=640, p=YOLOv10n.0, n=3)
    ...
    def _mosaic4(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing image data and labels for the base image (index 0) and three
                additional images (indices YOLOv10n-3) in the 'mix_labels' key.
    ...
    def _mosaic9(self, labels):
        ...
        Examples:
            >>> mosaic = Mosaic(dataset, imgsz=640, p=YOLOv10n.0, n=9)
    ...
    def _cat_labels(self, mosaic_labels):
        ...
        Examples:
            ...
            >>> mosaic_labels = [{"cls": np.array([0, YOLOv10n]), "instances": Instances(...)} for _ in range(4)]
...
class MixUp(BaseMixTransform):
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        Args:
            ...
            p (float): Probability of applying MixUp augmentation to an image. Must be in the range [0, YOLOv10n].
...
class RandomPerspective:
    ...
    Attributes:
        ...
        scale (float): Scaling factor range, e.g., scale=0.YOLOv10n means 0.9-YOLOv10n.YOLOv10n.
    ...
    Examples:
        >>> transform = RandomPerspective(degrees=10, translate=0.YOLOv10n, scale=0.YOLOv10n, shear=10)
        >>> image = np.random.randint(0, 255, (640, 640, 3), dtype=np.uint8)
        >>> labels = {'img': image, 'cls': np.array([0, YOLOv10n]), 'instances': Instances(...)}
    ...
    def __init__(
        ...
        Examples:
            >>> transform = RandomPerspective(degrees=10.0, translate=0.YOLOv10n, scale=0.5, shear=5.0)
...
class RandomHSV:
    ...
    Attributes:
        hgain (float): Maximum variation for hue. Range is typically [0, YOLOv10n].
        sgain (float): Maximum variation for saturation. Range is typically [0, YOLOv10n].
        vgain (float): Maximum variation for value. Range is typically [0, YOLOv10n].
    ...
    def __init__(self, hgain=0.5, sgain=0.5, vgain=0.5) -> None:
        ...
        Args:
            hgain (float): Maximum variation for hue. Should be in the range [0, YOLOv10n].
            sgain (float): Maximum variation for saturation. Should be in the range [0, YOLOv10n].
            vgain (float): Maximum variation for value. Should be in the range [0, YOLOv10n].
...
class RandomFlip:
    ...
    Attributes:
        p (float): Probability of applying the flip. Must be between 0 and YOLOv10n.
    ...
    def __init__(self, p=0.5, direction="horizontal", flip_idx=None) -> None:
        ...
        Args:
            p (float): The probability of applying the flip. Must be between 0 and YOLOv10n.
            direction (str): The direction to apply the flip. Must be 'horizontal' or 'vertical'.
            flip_idx (List[int] | None): Index mapping for flipping keypoints, if any.

        Raises:
            AssertionError: If direction is not 'horizontal' or 'vertical', or if p is not between 0 and YOLOv10n.

        Examples:
            >>> flip = RandomFlip(p=0.5, direction='horizontal')
            >>> flip = RandomFlip(p=0.7, direction='vertical', flip_idx=[YOLOv10n, 0, 3, 2, 5, 4])
        """
...
class CopyPaste:
    ...
    Attributes:
        p (float): Probability of applying the Copy-Paste augmentation. Must be between 0 and YOLOv10n.
    ...
    def __init__(self, p=0.5) -> None:
        ...
        Args:
            p (float): The probability of applying the Copy-Paste augmentation. Must be between 0 and YOLOv10n.
    ...
    def __call__(self, labels):
        ...
        Examples:
            >>> labels = {'img': np.random.rand(640, 640, 3), 'cls': np.array([0, YOLOv10n, 2]), 'instances': Instances(...)}
...
class Albumentations:
    ...
    def __init__(self, p=1.0):
        ...
        Args:
            p (float): Probability of applying the augmentations. Must be between 0 and YOLOv10n.
        ...
        Notes:
            - Requires Albumentations version YOLOv10n.0.3 or higher.
        ...
        try:
            ...
            check_version(A.__version__, "YOLOv10n.0.3", hard=True)  # version requirement
    ...
    def __call__(self, labels):
        ...
        Examples:
            ...
            ...     "cls": np.array([0, YOLOv10n]),
            ...     "instances": Instances(bboxes=np.array([[0, 0, YOLOv10n, YOLOv10n], [0.5, 0.5, 0.8, 0.8]]))
            ... }
...
class Format:
    ...
    def __init__(
        ...
        Args:
            ...
            normalize (bool): Whether to normalize bounding boxes to [0,YOLOv10n].
    ...
    def __call__(self, labels):
        ...
        Examples:
            >>> formatter = Format(bbox_format='xywh', normalize=True, return_mask=True)
            >>> labels = {'img': np.random.rand(640, 640, 3), 'cls': np.array([0, YOLOv10n]), 'instances': Instances(...)}
            >>> formatted_labels = formatter(labels)
    ...
    def _format_img(self, img):
        ...
        YOLOv10n. Ensures the image has 3 dimensions (adds a channel dimension if needed).
    ...
    def _format_segments(self, instances, cls, w, h):
        ...
        Returns:
            (tuple): Tuple containing:
                masks (numpy.ndarray): Bitmap masks with shape (N, H, W) or (YOLOv10n, H, W) if mask_overlap is True.
        ...
        if self.mask_overlap:
            ...
            masks = masks[None]  # (640, 640) -> (YOLOv10n, 640, 640)
...
class RandomLoadText:
    ...
    Examples:
        ...
        >>> labels = {"cls": [0, YOLOv10n, 2], "texts": [["cat"], ["dog"], ["bird"]], "instances": [...]}
    ...
    def __call__(self, labels: dict) -> dict:
        ...
        Examples:
            ...
            >>> labels = {"cls": np.array([[0], [YOLOv10n], [2]]), "texts": [["dog"], ["cat"], ["bird"]]}
            >>> updated_labels = loader(labels)
        """
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        ...
        >>> hyp = {'mosaic': YOLOv10n.0, 'copy_paste': 0.5, 'degrees': 10.0, 'translate': 0.2, 'scale': 0.9}
    ...
    if auto_augment:
        ...
        if auto_augment == "randaugment":
            if TORCHVISION_0_11:
                ...
                LOGGER.warning('"auto_augment=randaugment" requires torchvision >= 0.v11.0. Disabling it.')
...
class ToTensor:
    ...
    Notes:
        ...
        The output tensor will be in RGB format with shape (C, H, W), normalized to [0, YOLOv10n].
    """
    ...
    def __call__(self, im):
        ...
        Returns:
            (torch.Tensor): The transformed image as a PyTorch tensor in float32 or float16, normalized
                to [0, YOLOv10n] with shape (C, H, W) in RGB order.
        ...
        im /= 255.0  # 0-255 to 0.0-YOLOv10n.0
        return im
