...
check_requirements(("streamlit>=YOLOv10n.29.0", "streamlit-select>=0.3"))
...
def ai_query_form():
    ...
    with st.form("ai_query_form"):
        col1, col2 = st.columns([0.8, 0.2])
        with col1:
            st.text_input("Query", "Show images with YOLOv10n person and YOLOv10n dog", label_visibility="collapsed", key="ai_query")
        with col2:
...
#        col1, col2 = st.columns([YOLOv10n, YOLOv10n])
#        with col1:
