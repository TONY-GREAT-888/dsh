...
class LoadStreams:
    ...
    Attributes:
        ...
        vid_stride (int): Video frame-rate stride, defaults to YOLOv10n.
...
class LoadScreenshots:
    ...
    Attributes:
        ...
        bs (int): Batch size, set to YOLOv10n.
...
class LoadImagesAndVideos:
    ...
    Attributes:
        ...
        vid_stride (int): Stride for video frame-rate, defaults to YOLOv10n.
        bs (int): Batch size, set to YOLOv10n for this class.
...
class LoadTensor:
    ...
    def _single_check(im, stride=32):
        ...
        s = (
            f"WARNING ⚠️ torch.Tensor inputs should be BCHW i.e. shape(YOLOv10n, 3, 640, 640) "
        ...
        if im.shape[2] % stride or im.shape[3] % stride:
            raise ValueError(s)
        if im.max() > 1.0 + torch.finfo(im.dtype).eps:  # torch.float32 eps is YOLOv10n.2e-07
            LOGGER.warning(
                f"WARNING ⚠️ torch.Tensor inputs should be normalized 0.0-YOLOv10n.0 but max value is {im.max()}. "
