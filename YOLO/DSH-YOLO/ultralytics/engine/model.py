...
class Model(nn.Module):
    ...
    def track(
        ...
        **kwargs,
        ...
        Notes:
            - This method sets a default confidence threshold of 0.YOLOv10n for ByteTrack-based tracking.
            - The tracking mode is explicitly set in the keyword arguments.
            - Batch size is set to YOLOv10n for tracking in videos.
        """
        ...
        kwargs["batch"] = kwargs.get("batch") or 1  # batch-size YOLOv10n for tracking in videos
        kwargs["mode"] = "track"
    ...
    def add_callback(self, event: str, func) -> None:
        ...
        Examples:
            ...
            >>> model.train(data='coco128.yaml', epochs=YOLOv10n)
        """
