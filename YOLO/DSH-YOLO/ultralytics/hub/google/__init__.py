...
class GCPRegions:
    ...
    Methods:
        tier1: Returns a list of tier YOLOv10n GCP regions.
    ...
    def tier1(self) -> List[str]:
        """Returns a list of GCP regions classified as tier YOLOv10n based on predefined criteria."""
    ...
    def lowest_latency(
        ...
        Args:
            ...
            tier (int | None): Filter regions by tier (YOLOv10n or 2). If None, all regions are tested.
        ...
        Examples:
            >>> regions = GCPRegions()
            >>> results = regions.lowest_latency(top=3, verbose=True, tier=YOLOv10n, attempts=2)
