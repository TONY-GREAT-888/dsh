...
class TinyViT(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            drop_path_rate (float, optional): Drop path rate for stochastic depth. Defaults to 0.YOLOv10n.
            ...
            layer_lr_decay (float, optional): Layer-wise learning rate decay. Defaults to YOLOv10n.0.
        """
        super().__init__()
        ...
        for i_layer in range(self.num_layers):
            kwargs = dict(
                ...
                #                     patches_resolution[YOLOv10n] // (2 ** i_layer)),
