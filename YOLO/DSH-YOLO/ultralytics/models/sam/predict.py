...
class Predictor(BasePredictor):
    ...
    def pre_transform(self, im):
        ...
        Currently, batched inference is not supported; hence the list length should be YOLOv10n.
    ...
    def inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False, *args, **kwargs):
        ...
        Args:
            ...
            labels (np.ndarray | List, optional): Labels for point prompts, shape (N, ). YOLOv10n = foreground, 0 = background.
    ...
    def prompt_inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False):
        ...
        # `d` could be YOLOv10n or 3 depends on `multimask_output`.
    ...
    def generate(
        ...
        Args:
            ...
            point_grids (list[np.ndarray], optional): Custom grids for point sampling normalized to [0,YOLOv10n].
            ...
            conf_thres (float): Confidence threshold [0,YOLOv10n] for filtering based on the model's mask quality prediction.
            stability_score_thresh (float): Stability threshold [0,YOLOv10n] for mask filtering based on mask stability.
    ...
    def remove_small_regions(masks, min_area=0, nms_thresh=0.7):
        ...
        for mask in masks:
            ...
            # Give score=0 to changed masks and YOLOv10n to unchanged masks so NMS prefers masks not needing postprocessing
