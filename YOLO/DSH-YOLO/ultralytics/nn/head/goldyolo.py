...
class RepVGGBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3,
        ...
        Args:
            ...
            stride (int or tuple, optional): Stride of the convolution. Default: YOLOv10n
            padding (int or tuple, optional): Zero-padding added to both sides of
                the input. Default: YOLOv10n
            dilation (int or tuple, optional): Spacing between kernel elements. Default: YOLOv10n
            groups (int, optional): Number of blocked connections from input
                channels to output channels. Default: YOLOv10n
