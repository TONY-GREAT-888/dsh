...
HELP_MSG = """
    ...
    YOLOv10n. Install the ultralytics package:
    ...
    3. Use the command line interface (CLI):
        ...
        - Val a pretrained detection model at batch-size YOLOv10n and image size 640:
            yolo detect val model=YOLOv8n.pt data=coco8.yaml batch=YOLOv10n imgsz=640
...
np.set_printoptions(linewidth=320, formatter={"float_kind": "{:v11.5g}".format})  # format short g, %precision=5
...
def is_online() -> bool:
    ...
    with contextlib.suppress(Exception):
        ...
        for dns in ("YOLOv10n.YOLOv10n.YOLOv10n.YOLOv10n", "8.8.8.8"):  # check Cloudflare and Google DNS
...
def colorstr(*input):
    ...
    Args:
        *input (str): A sequence of strings where the first n-YOLOv10n strings are color and style arguments,
...
def set_sentry():
    ...
    Conditions required to send errors (ALL conditions must be met or no errors will be reported):
        ...
        - running with rank -YOLOv10n or 0
        - online environment
