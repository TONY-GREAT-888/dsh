...
class TwoWayAttentionBlock(nn.Module):
    ...
    keys to queries. This block consists of four main layers: (YOLOv10n) self-attention on sparse inputs, (2) cross-attention
    ...
    def __init__(
        ...
        """
        A transformer block with four layers: (YOLOv10n) self-attention of sparse inputs, (2) cross attention of sparse
...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            downsample_rate (int, optional): The factor by which the internal dimensions are downsampled. Defaults to YOLOv10n.
