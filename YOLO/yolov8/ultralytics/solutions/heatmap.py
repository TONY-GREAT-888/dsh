...
if __name__ == "__main__":
    classes_names = {0: "obstacle", 1: "ship", 2: "person", 3: "platform", 4: "rock", }  # example class names
    heatmap = Heatmap(classes_names)
# 示例代码
     #names = ["obstacle", "ship", "person", "platform", "rock"]  # 根据实际需求设置类别名称
     #heatmap_obj = heatmap.Heatmap(names)